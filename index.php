...
<head>
    ...
    <title>Accueil GT Hôtel</title>
</head>
<body>
    
<?php
require_once "src/View/Templates/Header_Home.php";
require_once "src/View/middle_Home.php" ?> 
<br>
<br>

<br>
<?php
require_once "src/View/Templates/footer_Home.php";
